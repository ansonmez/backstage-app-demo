...
```shell
docker build . -t quay.io/ansonmez/backstage:latest --no-cache
docker login quay.io/ansonmez/backstage
docker push quay.io/ansonmez/backstage:latest
```

note the images is already pushed to `ghcr.io/ansonmez/backstage-app-demo:main`
